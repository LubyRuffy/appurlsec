...
set CLASSPATH=%APP_HOME%\lib\jadx-cli-0.5.1.jar;%APP_HOME%\lib\android-4.3.jar;%APP_HOME%\lib\dx-1.8.jar;%APP_HOME%\lib\slf4j-api-1.7.6.jar;%APP_HOME%\lib\jadx-core-0.5.1.jar;%APP_HOME%\lib\jcommander-1.30.jar;%APP_HOME%\lib\logback-classic-1.1.1.jar;%APP_HOME%\lib\logback-core-1.1.1.jar
