...
public class HttpStatistics {
    ...
    static {
        a = HttpStatistics.class.getName();
    }
    ...
    public HttpStatistics() {
        ...
        this.b = new d();
        if (this.b != null) {
            this.b.a(a.a, "com.tencent.cloudsdk.pluginsdk.mna.report.HttpStatistics", "com.tencent.cloudsdk.defaultsdk.mna.report.HttpStatistics", new Class[r1i], new Object[r1i]);
        }
    }
