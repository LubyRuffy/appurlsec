...
public final class b {
    ...
    public static String a(byte[] r11_byteA, String r12_String) {
        int r2i;
        ...
        while (r4i < r6i) {
            r2i = r1i + 1;
            r5_byteA[r1i] = a[(r11_byteA[r4i] & 255) >> 2];
            r1i = r2i + 1;
            r5_byteA[r2i] = a[((r11_byteA[r4i] & 3) << 4) | ((r11_byteA[r4i + 1] & 255) >> 4)];
            int r7i = r1i + 1;
            r5_byteA[r1i] = a[((r11_byteA[r4i + 1] & 15) << 2) | ((r11_byteA[r4i + 2] & 255) >> 6)];
            r2i = r7i + 1;
            r5_byteA[r7i] = a[r11_byteA[r4i + 2] & 63];
            if ((r2i - r0i) % 76 != 0 || r2i == 0) {
                r1i = r2i;
            } else {
                r1i = r2i + 1;
                r5_byteA[r2i] = (byte) 10;
                r0i++;
            }
            r4i += 3;
        }
    ...
    public static byte[] a(byte[] r1_byteA) {
        return a(r1_byteA, r1_byteA.length);
    }

    public static byte[] a(byte[] r14_byteA, int r15i) {
        int r0i = (r15i / 4) * 3;
        if (r0i == 0) {
            return new byte[0];
        }
        ...
        while (true) {
            ...
            if (r2b == (byte) 10 || r2b == (byte) 13 || r2b == (byte) 32 || r2b == (byte) 9) {
                ...
                while (r6i < r15i) {
                    r2b = r14_byteA[r6i];
                    if (r2b == (byte) 10 || r2b == (byte) 13 || r2b == (byte) 32) {
                        r2i = r4i;
                        r4i = r3i;
                        r3i = r5i;
                        r6i++;
