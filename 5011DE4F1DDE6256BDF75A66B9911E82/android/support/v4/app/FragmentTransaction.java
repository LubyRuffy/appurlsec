...
public abstract class FragmentTransaction {
    ...
    public abstract FragmentTransaction add(int r1i, Fragment r2_Fragment, String r3_String);

    public abstract FragmentTransaction add(Fragment r1_Fragment, String r2_String);

    public abstract FragmentTransaction addToBackStack(String r1_String);
    ...
    public abstract FragmentTransaction replace(int r1i, Fragment r2_Fragment, String r3_String);
