...
public abstract class LoaderManager {
    ...
    public static void enableDebugLogging(boolean r0z) {
        w.a = r0z;
    }

    public abstract void destroyLoader(int r1i);

    public abstract void dump(String r1_String, FileDescriptor r2_FileDescriptor, PrintWriter r3_PrintWriter, String[] r4_StringA);
