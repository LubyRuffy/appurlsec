...
class e implements Runnable {
    ...
    e(SecureFileCache r1_SecureFileCache, String r2_String, String r3_String) {
    ...
    public void run() {
        try {
            OutputStream r1_OutputStream = new FileOutputStream(this.c.a(this.c.c(this.a)), false);
