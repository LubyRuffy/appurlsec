...
public class MyCollectionsAdapter extends DefaultAdapter<Object> {
    ...
    public class ViewHolder {
        ...
        public ViewHolder(View r4_View) {
            ...
            this.userIcon = (ImageView) r4_View.findViewById(R.id.userIcon);
        }
    }
    ...
    class a implements OnClickListener {
        ...
        public void onClick(View r5_View) {
            if (MyCollectionsAdapter.this.c instanceof ShareAble) {
                ShareAble r0_ShareAble = (ShareAble) MyCollectionsAdapter.this.c;
                r0_ShareAble.setSelectedArticle(this.c);
                r0_ShareAble.setCollectionIcon(this.d);
                boolean r1z = false;
                if (this.d == null || (!this.d.getTag().equals("active"))) {
                    ShareUtils.openShareDialog(MyCollectionsAdapter.this.c, r0_ShareAble.getShareRequestCode(), r1z);
                } else {
                    r1z = true;
                    ShareUtils.openShareDialog(MyCollectionsAdapter.this.c, r0_ShareAble.getShareRequestCode(), r1z);
                }
    ...
    class b implements OnClickListener {
        ...
        public void onClick(View r5_View) {
            if (QsbkApp.currentUser == null || SharePreferenceUtils.getSharePreferencesValue(QsbkDatabase.TOKEN).equals("noregister")) {
                ...
                QsbkApp.currentDataSource = MyCollectionsAdapter.this;
                QsbkApp.currentSelectItem = this.a;
                Intent r1_Intent = new Intent(MyCollectionsAdapter.this.c, SingleArticle.class);
                r1_Intent.putExtra(OneProfileActivity.SOURCE, ((IVotePoint) MyCollectionsAdapter.this.c).getVotePoint() + (QsbkApp.currentSelectItem + 1));
                MyCollectionsAdapter.this.c.startActivity(r1_Intent);
            }
        }
    }
    ...
    class c implements OnClickListener {
        ...
        public void onClick(View r7_View) {
            ...
            if (!this.b.isHighlighted()) {
                ...
                Article r0_Article = (Article) MyCollectionsAdapter.this.b.get(this.a);
                r0_Article.vote_down++;
                if (this.d.isHighlighted()) {
                    this.d.setHighlighted(false);
                    r0_Article = (Article) MyCollectionsAdapter.this.b.get(this.a);
                    r0_Article.vote_up--;
                }
                String r1_String = h;
                Object[] r2_ObjectA = new Object[2];
                r2_ObjectA[r4z] = Integer.valueOf(((Article) MyCollectionsAdapter.this.b.get(this.a)).vote_up);
                r2_ObjectA[1] = Integer.valueOf(((Article) MyCollectionsAdapter.this.b.get(this.a)).comment_count);
                this.c.setText(String.format(r1_String, r2_ObjectA));
                MyCollectionsAdapter.this.a(this.a, "dn", ((Article) MyCollectionsAdapter.this.b.get(this.a)).id, "active");
            }
        }
    }
    ...
    class d implements OnClickListener {
        ...
        public void onClick(View r6_View) {
            ...
            MyCollectionsAdapter.this.f.loadImage(this.d, this.e);
    ...
    class e implements OnClickListener {
        ...
        public void onClick(View r4_View) {
            Intent r0_Intent = new Intent(MyCollectionsAdapter.this, ImageViewer.class);
            r0_Intent.putExtra("contentId", this.a);
            r0_Intent.putExtra("imageName", this.b);
            MyCollectionsAdapter.this.startActivity(r0_Intent);
        }
    }
    ...
    class f implements OnClickListener {
        ...
        public void onClick(View r8_View) {
            if (!this.b.isHighlighted()) {
                ...
                MyCollectionsAdapter.this.a(this.a, "up", ((Article) MyCollectionsAdapter.this.b.get(this.a)).id, "active");
                String r1_String = h;
                Object[] r2_ObjectA = new Object[2];
                r2_ObjectA[0] = Integer.valueOf(((Article) MyCollectionsAdapter.this.b.get(this.a)).vote_up);
                r2_ObjectA[1] = Integer.valueOf(((Article) MyCollectionsAdapter.this.b.get(this.a)).comment_count);
                this.c.setText(String.format(r1_String, r2_ObjectA));
            }
        }
    ...
    class g implements OnClickListener {
        ...
        public g(String r3_String, String r4_String, String r5_String) {
            this.a = null;
            this.b = null;
            this.c = null;
            this.a = r3_String;
        ...
        public void onClick(View r6_View) {
            if (QsbkApp.currentUser != null) {
                Intent r0_Intent = new Intent(MyCollectionsAdapter.this.c, OneProfileActivity.class);
                if (QsbkApp.currentUser.userId.equals(this.a)) {
                    ...
                    r0_Intent.putExtra(OneProfileActivity.MSG_SOURCE, new ChatMsgSource(2, this.a, this.e).encodeToJsonObject().toString());
                }
                MyCollectionsAdapter.this.c.startActivity(r0_Intent);
            } else {
                Toast.makeText(MyCollectionsAdapter.this.c, "\u767b\u9646\u540e\u624d\u80fd\u67e5\u770b\u522b\u4eba\u7684\u4fe1\u606f\u54e6", 1).show();
            }
        }
    ...
    static {
        i = MyCollectionsAdapter.class.getName();
    }

    public MyCollectionsAdapter(Activity r5_Activity, ListView r6_ListView, ArrayList<Object> r7_ArrayList_Object) {
        ...
        this.g = QsbkApp.getInstance().getAvatarWorker(r5_Activity);
        if (h == null) {
            h = this.c.getResources().getString(R.string.points_and_count);
        }
        Resources r0_Resources = this.c.getResources();
        DisplayMetrics r1_DisplayMetrics = r0_Resources.getDisplayMetrics();
        this.j = r1_DisplayMetrics.widthPixels - r0_Resources.getDimensionPixelSize(R.dimen.profile_item_margin) * 2;
        k = (int) (((double) r1_DisplayMetrics.heightPixels) * 1.5d);
    }
    ...
    private void a(View r5_View) {
        ...
        if (r1_View.getLayoutParams() != null) {
            LayoutParams r0_LayoutParams = (LayoutParams) r1_View.getLayoutParams();
    ...
    private void a(String r5_String, String r6_String, ImageView r7_ImageView) {
        if (TextUtils.isEmpty(r6_String) || "null".equals(r6_String.trim())) {
            ...
            r1_ObjectA[2] = Globalization.MEDIUM;
            r1_ObjectA[3] = r6_String;
            this.g.loadImage(String.format(r0_String, r1_ObjectA), r7_ImageView);
            if (UIHelper.isNightTheme()) {
    ...
    private void a(Article r5_Article, ViewHolder r6_ViewHolder) {
        ...
        if (TextUtils.isEmpty(r5_Article.image) || r5_Article.image.equals("null") || r5_Article.image_size == null) {
            ...
            a(r6_ViewHolder.imageView, r5_Article.image_size.smallSize(), this.j, k);
            a(r5_Article.vote_up, r5_Article.vote_down, r5_Article.comment_count, r6_ViewHolder);
            a(r5_Article.location, r6_ViewHolder.location);
        }
    }
    ...
    private void b(Article r5_Article, ViewHolder r6_ViewHolder) {
        if (TextUtils.isEmpty(r5_Article.login) || "Guest".equals(r5_Article.login)) {
            ...
            a(r5_Article.user_id, r5_Article.user_icon, r6_ViewHolder.userIcon);
            OnClickListener r0_OnClickListener = new g(r5_Article.user_id, r5_Article.login, r5_Article.user_icon);
            r0_OnClickListener.setArticleId(r5_Article.id);
            r6_ViewHolder.userInfoLayout.setOnClickListener(r0_OnClickListener);
        }
    }

    private void c(Article r4_Article, ViewHolder r5_ViewHolder) {
    ...
    public View getView(int r10i, View r11_View, ViewGroup r12_ViewGroup) {
        ...
        if (r11_View == null) {
            r11_View = this.d.inflate(R.layout.layout_article_item, null);
        ...
        r7_ViewHolder.imageView.setColorFilter(null);
        if (r10i == getCount() - 1) {
            a(r11_View);
        }
