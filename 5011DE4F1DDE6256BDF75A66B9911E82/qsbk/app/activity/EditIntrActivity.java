...
public class EditIntrActivity extends SingleEditTextBaseActivity {
    ...
    public Map<String, Object> getPostParams() {
        ...
        r0_Map_String__Object.put(EDIT_TYPE.TYPE_INTRODUCE, this.r.getText().toString());
